...
A reusable library for text analysis and comparison, intended as a tool for analyzing financial filings
...
# Needed for initialization if not used NLTK beforehand
# nltk.download('punkt')
...
class Bizparse:
    ...
    def sentence_parser(self, filename):
        ...
        which have certain keywords within it. Builds a dictionary that contains keywords as keys and an average
        sentiment of sentences that contain said keyword
        """
    ...
    def plot_sentence_parser_data(self, label_lst, color="blue"):
        ...
        Takes in list of doc labels that you want to analyze and plots them next to each other.
        Labels must correspond to document loaded using sentence parser, not default.
        """
